	...
	?>
		...
		if ( 'post' === get_post_type() ) :
			...
			<div class="entry-meta">
				<?php
				radioexitofm_posted_on();
				radioexitofm_posted_by();
				?>
			</div><!-- .entry-meta -->
		<?php endif; ?>
	</header><!-- .entry-header -->

	<?php /*radioexitofm_post_thumbnail();*/ ?>
	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'radioexitofm' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'radioexitofm' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
